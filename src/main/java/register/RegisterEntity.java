...
public class RegisterEntity {
    ...
    {
        registerEntity("ball", EntityBall.class, Reference.ENTITY_BALL, 160, 11437146, 000000);
    ...
    private static void registerEntity(String name, Class<? extends Entity> entity, int id, int range, int color1, int color2){
        EntityRegistry.registerModEntity(new ResourceLocation(Reference.MODID + ":" + name), entity, name, id, SportsMod.instance, range, 1, true, color1, color2);
    }
}
